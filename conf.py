...
rel="cc:attributionURL">Hassan Kassem</a> is licensed under a
<a rel="license" href="http://creativecommons.org/licenses/by-nc-sa/4.0/">
...
TWITTER_CARD = {
    ...
    'card': 'summary_large_image',          # Card type, you can also use 'summary',
